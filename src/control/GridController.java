...
/**
 * GridController.java - Responsible for building the components that create a grid.  It then initializes the grid
 * and returns it.
 *
...
public class GridController {
	 ...
	 * @return
	 */
	private boolean buildPuzzle( DictionaryFile dictionaryFile ) {
